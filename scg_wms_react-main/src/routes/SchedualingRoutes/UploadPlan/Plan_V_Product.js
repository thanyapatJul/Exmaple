...
const UploadPlan = () => {
  ...
  const [costestimateprod, setCostestimateprod] = useState(0);
  ...
  const fetchRemainPlan = async (startDate, endDate) => {
    try {
      ...
      if (response.data && response.data.data) {
        ...
        setCostestimate(response.data.estimate_price);
        setCostestimateprod(response.data.estimate_price_prod);
              ...
              <CardBody>
                <Stat>
                  ...
                  <VStack spacing={4}>
                    ...
                    <StatLabel mt={2}>Production Cost</StatLabel>
                    <StatNumber color="orange.500" fontSize="md">
                      {costestimateprod} MB
                    </StatNumber>
                  </VStack>
                </Stat>
