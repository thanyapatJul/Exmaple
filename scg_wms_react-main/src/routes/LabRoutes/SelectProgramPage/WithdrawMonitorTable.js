...
const HomePage = (props) => {
    ...
    const fetchWithdrawData = () => {
        ...
        client.get('wms/api/get_monitorwithdrawplan', { params: queryParams })
            .then(response => {
        ...
        <Box p={2} w={"100%"} borderRadius={"xl"} border='1px' borderColor={borderColor[colorMode]} bgColor={bgColor[colorMode]}>
            ...
            >
                        ...
                        {(rowData, rowIndex) => {
                            return (
                                <VStack align={"start"} spacing={0}>
                                    ...
                                    <Text color={headerTextColor[colorMode]}>{rowData["name_th"]}</Text>
                                </VStack>
                            );
                        }}
                    </Cell>
                ...
                <Column verticalAlign="middle" width={140} resizable align="center">
                    ...
                    <Cell style={{ backgroundColor: headerBgColor[colorMode] }}>
                        {(rowData, rowIndex) => {
                            return (<Tag p={2} size={"sm"} colorScheme='red' variant='solid' rounded={"md"}>ยังไม่ได้ส่งเบิก</Tag>);
                        }}
                    </Cell>
                </Column>
            </Table>
